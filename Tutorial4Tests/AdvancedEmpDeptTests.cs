...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(emp => emp.DeptNo == 30).Min(emp => emp.Sal);
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps
            .Join(emps, emp => emp.Mgr, manager => manager.EmpNo, (emp, manager) => new { Employee = emp.EName, Manager = manager.EName })
            .ToList();
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        //Gave up on this one, I could not get the two to join properly ever
       /* var result = emps.
